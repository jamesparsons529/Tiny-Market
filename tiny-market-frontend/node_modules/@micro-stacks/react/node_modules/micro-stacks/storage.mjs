...
var ae=Object.defineProperty;var ce=(r,e,t)=>e in r?ae(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var z=(r,e,t)=>(ce(r,typeof e!="symbol"?e+"":e,t),t);function de(r){return (r==null?void 0:r.map(e=>({...e,domain:e.path})))??null}function M(r){let{hubInfo:e,privateKey:t,gaiaHubUrl:o,associationToken:n=null,scopes:s}=r,{challenge_text:i}=e,a=bytesToHex(getPublicKey(t,!0)),u=getRandomBytes(16).toString();return {gaiaChallenge:i,hubUrl:o,iss:a,salt:u,associationToken:n,scopes:de(s)}}async function ge(r){let e=M(r);return `v1:${await new TokenSigner("ES256K",r.privateKey).sign(e)}`}function ye(r){let e=M(r);return `v1:${new TokenSigner("ES256K",r.privateKey).signSync(e)}`}var J={challenge_text:'["gaiahub","0","storage2.blockstack.org","blockstack_storage_please_sign"]',latest_auth_version:"v1",max_file_upload_size_megabytes:20,read_url_prefix:"https://gaia.blockstack.org/hub/"};async function ze(r,e=!1){let{gaiaHubUrl:t,privateKey:o,associationToken:n,scopes:s}=r,i=J;e&&(i=await(await fetchPrivate(`${t}/hub_info`)).json());let{read_url_prefix:a,max_file_upload_size_megabytes:u}=i,c=await ge({hubInfo:i,privateKey:o,gaiaHubUrl:t,associationToken:n,scopes:s});return {address:privateKeyToBase58Address(o),url_prefix:a,token:c,server:t,max_file_upload_size_megabytes:u??20}}function je(r){let{gaiaHubUrl:e,privateKey:t,associationToken:o,scopes:n}=r,s=J,{read_url_prefix:i,max_file_upload_size_megabytes:a}=s,u=ye({hubInfo:s,privateKey:t,gaiaHubUrl:e,associationToken:o,scopes:n});return {address:privateKeyToBase58Address(t),url_prefix:i,token:u,server:e,max_file_upload_size_megabytes:a??20}}var w={MISSING_PARAMETER:"missing_parameter",REMOTE_SERVICE_ERROR:"remote_service_error",INVALID_STATE:"invalid_state",NO_SESSION_DATA:"no_session_data",DOES_NOT_EXIST:"does_not_exist",FAILED_DECRYPTION_ERROR:"failed_decryption_error",INVALID_DID_ERROR:"invalid_did_error",NOT_ENOUGH_FUNDS_ERROR:"not_enough_error",INVALID_AMOUNT_ERROR:"invalid_amount_error",LOGIN_FAILED_ERROR:"login_failed",SIGNATURE_VERIFICATION_ERROR:"signature_verification_failure",CONFLICT_ERROR:"conflict_error",NOT_ENOUGH_PROOF_ERROR:"not_enough_proof_error",BAD_PATH_ERROR:"bad_path_error",VALIDATION_ERROR:"validation_error",PAYLOAD_TOO_LARGE_ERROR:"payload_too_large_error",PRECONDITION_FAILED_ERROR:"precondition_failed_error",UNKNOWN:"unknown"};Object.freeze(w);var k=class extends Error{message;code;parameter;constructor(e){super();let t=e.message,o=`Error Code: ${e.code}`,n=this.stack;if(n)o+=`Stack Trace:
