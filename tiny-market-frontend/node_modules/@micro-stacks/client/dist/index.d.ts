import { ContractCallTxOptions, FinishedTxData, StxTransferTxOptions, ContractDeployTxOptions, StacksSessionState, SignedOptionsWithOnHandlers, SignatureData, Profile } from 'micro-stacks/connect';
...
declare class MicroStacksClient {
    ...
    getSignInMessage: ({ domain, nonce, version, }: {
