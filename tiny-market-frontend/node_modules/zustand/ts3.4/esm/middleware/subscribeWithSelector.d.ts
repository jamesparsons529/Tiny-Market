...
declare type SubscribeWithSelector = <T extends State, Mps extends [
...
declare type WithSelectorSubscribe<S> = S extends {
    getState: () => infer T;
} ? Write<S, StoreSubscribeWithSelector<Cast<T, State>>> : never;
declare module '../vanilla' {
    interface StoreMutators<S, A> {
        ['zustand/subscribeWithSelector']: WithSelectorSubscribe<S>;
    }
}
declare type StoreSubscribeWithSelector<T extends State> = {
    subscribe: {
